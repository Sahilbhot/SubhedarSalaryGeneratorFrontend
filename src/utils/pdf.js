...
export function generateSalaryPDF({ employee, calc, month, year, logoDataUrl }) {
  const monthName = MONTHS[month - 1];

  const logoHtml = logoDataUrl
    ? `<img src="${logoDataUrl}" alt="Hotel Subhedar Logo" style="height:70px;object-fit:contain;" />`
    : `<div style="font-family:'Playfair Display',serif;font-size:28px;font-weight:700;color:#c2272d;">Hotel Subhedar</div>`;
...
<body>
  ...
  <div class="section">
    ...
    <div class="row"><span class="label">Daily Rate (Salary × 12 ÷ 365)</span><span class="value">${formatCurrency(calc.dailyRate)}/day</span></div>
    <div class="row"><span class="label">Paid Leave Days Added</span><span class="value">+ ${calc.paidLeaves} days</span></div>
    <div class="row"><span class="label">Leaves Taken</span><span class="value">− ${calc.leavesTaken} days</span></div>
    <div class="row"><span class="label">Effective Working Days</span><span class="value">${calc.effectiveDays} days</span></div>
