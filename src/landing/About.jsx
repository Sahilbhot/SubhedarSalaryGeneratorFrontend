import {
  Leaf, Ban, Palette, Droplets, Beef, Flame, ShieldCheck, Home, Check,
} from 'lucide-react';
          ...
          <div className="lp-about-grid">
            <div>
              ...
              <p className="lp-about-lead">
                At <strong>{HOTEL.name}</strong>, every dish is a tribute to authentic
                Maharashtrian cooking. We grind our spices by hand each morning and cook
                in small batches so every plate carries the honest, home-style flavour
                our guests come back for.
              </p>
              <p className="lp-about-lead">
                No shortcuts, no compromises — just fresh ingredients, traditional methods,
            ...
            <div>
              ...
              <h2 className="lp-heading" style={{ fontSize: '27px' }}>What makes every plate honest</h2>
              <div className="lp-promises">
                {PROMISES.map((p, i) => {
                  const Icon = ICONS[p.icon] || Leaf;
                  return (
                      <div key={i} className="lp-promise">
                        <div className="lp-promise-icon"><Icon /></div>
                        <p>{p.text}</p>
                      </div>
                  );
                })}
