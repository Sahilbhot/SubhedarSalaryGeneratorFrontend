  ...
  return (
      <>
          ...
          <div className="lp-container lp-nav-inner">
            <a href="#home" className="lp-brand" onClick={closeMobile}>
              ...
              <span className="lp-brand-text">
                ...
                <span className="lp-brand-tag" lang="mr">{HOTEL.taglineMarathi}</span>
              </span>
            </a>
        ...
        <div className={`lp-mobile-menu ${mobileOpen ? 'open' : ''}`}>
          <button className="lp-mobile-close" aria-label="Close menu" onClick={closeMobile}><X /></button>
          {LINKS.map(l => (
              <a key={l.id} href={`#${l.id}`} onClick={closeMobile}>{l.label}</a>
          ))}
          <button className="lp-btn lp-btn--gold" onClick={() => { closeMobile(); onLogin(); }}>
            <LogIn />Login
          </button>
        </div>
      </>
