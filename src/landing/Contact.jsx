          ...
          <div className="lp-contact-grid">
            <div className="lp-contact-info">
              <div className="lp-info-row">
                <div className="lp-info-icon"><MapPin /></div>
                <div>
                  <h5>Address</h5>
                  <p>{HOTEL.address.line1}, {HOTEL.address.line2}, {HOTEL.address.city}</p>
                </div>
              </div>
              <div className="lp-info-row">
              ...
              <div className="lp-info-row">
                <div className="lp-info-icon"><Mail /></div>
                <div>
                  <h5>Email</h5>
              ...
              <div className="lp-info-row">
                <div className="lp-info-icon"><Clock /></div>
                <div>
                  <h5>Opening Hours</h5>
                  {HOURS.map(h => (
              ...
              <div className="lp-info-row">
                <div className="lp-info-icon"><Camera /></div>
                <div>
                  <h5>Instagram</h5>
                  <a href={HOTEL.instagramUrl} target="_blank" rel="noreferrer">{HOTEL.instagram}</a>
                </div>
              </div>
            </div>
            ...
            <form className="lp-form" onSubmit={handleSubmit}>
              <div className="field">
                ...
                <input id="c-name" type="text" required value={form.name}
                       onChange={e => setField('name', e.target.value)} placeholder="e.g. Rahul Patil" />
              </div>
