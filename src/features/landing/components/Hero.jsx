    ...
    <section id="home" className="lp-hero">
      ...
      <div className="lp-hero-inner">
        ...
        <p className="lp-hero-desc">
          Authentic Maharashtrian flavours, freshly hand-ground masalas, and honest home-style
          cooking — served the way it was always meant to be.
        </p>
        <div className="lp-hero-actions">
          <a href="#menu" className="lp-btn lp-btn--gold">
            <UtensilsCrossed />
            View Menu
          </a>
          <a
